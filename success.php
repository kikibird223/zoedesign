        ...
        <div class="col-lg-8 col-md-7 col-sm-12" id="product-management">
            ...
            <form method="POST" action="add_product.php" enctype="multipart/form-data" class="mb-4">
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-4">
                        <input type="file" name="product_image" class="form-control" required onchange="previewImage(event, 'productImagePreview')">
                        <img id="productImagePreview" src="" alt="Image Preview" style="display: none; height: 100px; margin-top:10px;">
                    </div>
                    <div class="col-md-4">
                        <input type="url" name="product_iframe_url" class="form-control" placeholder="崁入iframe URL" onchange="previewIframe(event, 'iframePreview')">
                        <iframe id="iframePreview" src="" style="display: none; width: 100%; height: 100px;margin-top:10px;" frameborder="0" allowfullscreen></iframe>
                    </div>
                ...
                <tbody>
                    <?php foreach ($products as $product) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_product.php?product_id=<?php echo $product['product_id']; ?>" class="btn btn-warning btn-sm" style="background-color: rgba(55, 181, 166, 0.3); border: none;">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="delete_product.php?product_id=<?php echo $product['product_id']; ?>" class="btn btn-danger btn-sm" style="background-color: rgba(55, 181, 166, 0.5); border: none;" onclick="return confirm('Are you sure you want to delete this product: <?php echo $product['product_title']; ?>?')">
                                    <i class="bi bi-x-lg"></i>
                                </a>
                            </td>
                        </tr>
