...
/*-----------------------------------------------------------------------------------*/
    ...
    .services .icon-box.product-design:hover {
        ...
        /* Replace with the path to your product design image */
        top: 0;
        border-radius: 0px;
    }
    ...
    .services .icon-box.mechanical-design:hover {
        ...
        /* Replace with the path to your mechanical design image */
        top: 0;
        border-radius: 0px;
    }
    ...
    .services .icon-box.animation:hover {
        ...
        /* Replace with the path to your animation image */
        top: 0;
        border-radius: 0px;
    }
    ...
    .services .icon-box.graphic-design:hover {
        background-image: url('img/hero-bg.jpg');
        /* Replace with the path to your graphic design image */
        top: 0;
        border-radius: 0px;
    }
...
<style>
    ...
    #accept-privacy:hover {
        background-color: black; /* 懸停時的背景顏色 */
    }
...
<section id="contact" class="contact section-bg">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form class="php-email-form" method="POST" name="contact-form" action="add_massage.php">
                <div class="row">
                ...
                <div class="form-group mt-3">
                    <textarea class="form-control" name="c_message" rows="5" placeholder="Message" required></textarea>
                </div>
                <div class="text-center"><button type="submit" value="送出">Send Message</button></div>
            </form>
        </div>
...
<!-- 隱私政策同意提示 -->
<div id="privacy-notice" style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: rgba(255,255, 255, 0.8); padding: 15px; z-index: 2;">
    <div style="max-width: 1200px; margin: auto; text-align: center;">
        <p style="margin: 0; font-size: 14px;">
            我們使用cookies收集數據以提升服務體驗。詳細資訊請參閱我們的
            <a href="privacy-policy.html" style="color: #007bff; text-decoration: underline;">隱私政策</a>。
            <!-- <br> -->
            按「同意」以繼續。
        </p>
        <button id="accept-privacy" style="background-color: #007bff; color: white; border: none; padding: 10px 15px; margin-top: 10px; cursor: pointer;">
            同意
        </button>
    </div>
</div>
...
<script>
    document.getElementById('accept-privacy').addEventListener('click', function() {
        document.getElementById('privacy-notice').style.display = 'none'; // 隱藏提示
        // 此處可以添加代碼來記錄用戶同意的狀態
        localStorage.setItem('privacyAccepted', 'true'); // 記錄用戶的同意
    });

    // 檢查用戶是否已經同意過隱私政策
    if (localStorage.getItem('privacyAccepted') === 'true') {
        document.getElementById('privacy-notice').style.display = 'none'; // 如果已同意則隱藏提示
    }
</script>
